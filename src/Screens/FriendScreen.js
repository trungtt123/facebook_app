            ...
            >
                <View style={{ backgroundColor: 'white', paddingHorizontal: 20 }}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={{ marginLeft: 5, padding: 8, paddingHorizontal: 10, borderRadius: 20, backgroundColor: COMMON_COLOR.GRAY_COLOR_BACKGROUND }}>
